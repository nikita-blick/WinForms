...
namespace Clock
{
	public partial class AlarmDialog : Form
	{
		...
		{
			Console.WriteLine("clbWeekDays.CheckedItems.Changed");
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			{
				MessageBox.Show(this, "Выберите хотябы один день недели", "Ну Ежж...", MessageBoxButtons.OK, MessageBoxIcon.Warning);
				return;
			}*/
